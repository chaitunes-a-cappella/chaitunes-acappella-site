...
export default function Members({ fontClass1, fontClass2 }: Props) {
        ...
        return (
            <div>
                ...
                <div className="w-full h-full flex flex-col items-center text-center pb-10">
                    ...
                    >
                        <h1 className={fontClass1}>Current Members</h1>
                    </div>
                    <br />
                    <br />
                ...
                {/* Alumni Section */}
                <div>
                    <h2 className={fontClass2 + ' text-chai-dark-blue text-5xl font-bold mb-4 text-decoration-line: underline flex items-center justify-center'}>Alumni</h2>
                    <div className={fontClass1 + ' flex flex-col items-center text-center pb-10 text-chai-dark-blue text-xl'}>
